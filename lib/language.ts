  ...
  resources: {
    en: {
      translation: {
        ...
        section_business_problem: "Business Problem",
        section_constraints: "Constraints",
        section_architecture: "Architecture",
        section_contribution: "My Contribution",
        section_tradeoffs: "Trade-offs & Decisions",
    ...
    de: {
      translation: {
        ...
        read_case_study: "Case Study lesen",
        section_overview: "Überblick",
        section_business_problem: "Geschäftsproblem",
        section_constraints: "Rahmenbedingungen",
        section_architecture: "Architektur",
        section_contribution: "Mein Beitrag",
        section_tradeoffs: "Abwägungen & Entscheidungen",
    ...
    es: {
      translation: {
        ...
        section_business_problem: "Problema de negocio",
        section_constraints: "Restricciones",
        section_architecture: "Arquitectura",
        section_contribution: "Mi contribución",
        section_tradeoffs: "Trade-offs y decisiones",
        section_outcome: "Resultado",
